function moving_bar(cyclespersecond, p)
...
movieDurationSecs = 300;   % Abort demo after 60 seconds.
...
bar = white*(1:visiblesize <= bar_width);
...
while(vbl < vblendtime)
   ...
   if xoffset < -visiblesize
       xoffset = shiftperframe; % set to same position
