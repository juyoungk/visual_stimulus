...
testscreen_colors;
%% test flash
flash_annulus_stims('radius', 2000, 'color', [0 1 1], 'halfPeriodSecs', 1, 'Ncycle', 30);

%% 
flash_annulus_stims('radius', 2000, 'color', [0 1 0], 'halfPeriodSecs', 2, 'Ncycle', 20);

%% Additional flash 1
flash_annulus_stims('radius', 1400, 'color', [0 1 1], 'halfPeriodSecs', 2, 'Ncycle', 20);

%% Additional flash 2
flash_annulus_stims('radius', 2000, 'color', [0 0 1], 'halfPeriodSecs', 2, 'Ncycle', 20);
